...
from api.v1.authentication.utilities import deprecated, duration_from_string

from api.v1.authentication.exceptions import (
    AuthenticationError,
    BlacklistedError,
    ClaimCollisionError,
    EarlyRefreshError,
...
from api.v1.authentication.constants import (
...
class Praetorian:
    ...
    def send_registration_email(
        ...
        if template is None:
            template = self.confirmation_template
    ...
    def send_reset_email(
        ...
        return self.send_token_email(
            user.email, user, template, sender,
