...
def sellProduct(product_name, product_description, product_price, product_user_id, product_category_id, product_w, product_h):
    #json = {"product_name": product_name, "product_description": product_description, "product_price": product_price,
    #        "product_user_id": product_user_id, "product_category_id": product_category_id, "product_w":product_w, "product_h":product_h}
    #response_json, response_status_code = send_request(api_url+"/api/v1/products/sell", json)
    #product_id = "3"
    #if response_status_code == 201:
...
def getCategories():
    #response_json, response_status_code = send_request(api_url+"/api/v1/categories")
...
def getProductDetails():
    # response_json, response_status_code = send_request(api_url+"/api/v1/products/new_arrivals")
    # if response_status_code == 200:
    #    return "Success! Check your email to validate your account", "success"
...
def getCategoryProducts(categoryName=None, page=1):
    ...
    #    response_json, response_status_code = send_request(api_url+"/api/v1/products/" + str(page))
    #else:
    #    response_json, response_status_code = send_request(api_url+"/api/v1/products/" + categoryName + "/" + str(page))
...
def getWishListProducts():
    # response_json, response_status_code = send_request(api_url+"/api/v1/products/wishlist")
    # if response_status_code == 200:
    #    return "Success! Check your email to validate your account", "success"
